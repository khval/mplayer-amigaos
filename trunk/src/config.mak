...
prefix  = $(DESTDIR)/usr/local/amiga/ppc-amigaos/SDK/local/newlib
BINDIR  = $(DESTDIR)/usr/local/amiga/ppc-amigaos/SDK/local/newlib/bin
DATADIR = $(DESTDIR)/usr/local/amiga/ppc-amigaos/SDK/local/newlib/share/mplayer
LIBDIR  = $(DESTDIR)/usr/local/amiga/ppc-amigaos/SDK/local/newlib/lib
MANDIR  = $(DESTDIR)/usr/local/amiga/ppc-amigaos/SDK/local/newlib/share/man
CONFDIR = $(DESTDIR)/usr/local/amiga/ppc-amigaos/SDK/local/newlib/etc/mplayer
...
CFLAGS   = -gstabs -Wstrict-prototypes -Wmissing-prototypes -Wundef -Wdisabled-optimization -Wno-pointer-sign -Wdeclaration-after-statement -std=gnu99 -Wall -Wno-switch -Wpointer-arith -Wredundant-decls -O3 -mstring -mmultiple -mfused-madd -fschedule-insns2 -fno-strict-aliasing -ffast-math -fomit-frame-pointer -D_LARGEFILE_SOURCE -D_FILE_OFFSET_BITS=64 -D_LARGEFILE64_SOURCE -DNEWLIB -D__USE_INLINE__ -I. -Ilibdvdread4 -Ilibdvdnav     
ASFLAGS  = $(CFLAGS)
CXXFLAGS =  -gstabs -Wstrict-prototypes -Wmissing-prototypes -Wundef -Wdisabled-optimization -Wno-pointer-sign -Wdeclaration-after-statement -std=gnu99 -Wall -Wno-switch -Wpointer-arith -Wredundant-decls -O3 -mstring -mmultiple -mfused-madd -fschedule-insns2 -fno-strict-aliasing -ffast-math -fomit-frame-pointer -D_LARGEFILE_SOURCE -D_FILE_OFFSET_BITS=64 -D_LARGEFILE64_SOURCE -D__STDC_CONSTANT_MACROS -D__STDC_LIMIT_MACROS -DNEWLIB -D__USE_INLINE__ -I. -Ilibdvdread4 -Ilibdvdnav      
...
EXTRALIBS          =  -lSDL -lpng -lz -ljpeg -lungif -lfaac -lopencore-amrnb -lx264 -lz -lbz2 -lmad -lspeex -lm -lunix -lpthread -lauto
EXTRALIBS_MPLAYER  =  
EXTRALIBS_MENCODER =  
