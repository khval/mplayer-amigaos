...
void ds_read_packet(demux_stream_t *ds, stream_t *stream, int len, double pts, int64_t pos, int flags);

int demux_fill_buffer(demuxer_t *demux,demux_stream_t *ds);
int ds_fill_buffer(demux_stream_t *ds);

static inline int64_t ds_tell(demux_stream_t *ds){
...
int ds_parse(demux_stream_t *sh, uint8_t **buffer, int *len, double pts, int64_t pos);
