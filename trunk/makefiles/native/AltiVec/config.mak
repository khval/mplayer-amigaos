...
prefix  = $(DESTDIR)/SDK/Local
BINDIR  = $(DESTDIR)/SDK/Local/C
DATADIR = $(DESTDIR)PROGDIR:
LIBDIR  = $(DESTDIR)PROGDIR:
MANDIR  = $(DESTDIR)/SDK/Local/share/man
CONFDIR = $(DESTDIR)PROGDIR:
...
CFLAGS   = -Wundef -Wall -Wno-switch -Wno-parentheses -Wpointer-arith -Wredundant-decls -Wstrict-prototypes -Wmissing-prototypes -Wdisabled-optimization -Wno-pointer-sign -Wdeclaration-after-statement -std=gnu99  -O4    -ffast-math -fomit-frame-pointer -D_LARGEFILE_SOURCE -D_FILE_OFFSET_BITS=64 -D_LARGEFILE64_SOURCE -DNEWLIB -D__USE_INLINE__ -I. -Iffmpeg -mcrt=newlib -mstrict-align -maltivec -I/SDK/Include/include_h/ -I/SDK/newlib/include/ -I/SDK/Local/newlib/include/ -I/SDK/Local/common/include/ -Ilibdvdread4/ -Ilibdvdnav/   -I/SDK/local/common/include/freetype2 -DHAVE_INT32_T
CXXFLAGS = -Wundef -Wall -Wno-switch -Wno-parentheses -Wpointer-arith -Wredundant-decls  -O4    -ffast-math -fomit-frame-pointer -D_LARGEFILE_SOURCE -D_FILE_OFFSET_BITS=64 -D_LARGEFILE64_SOURCE -D__STDC_CONSTANT_MACROS -D__STDC_LIMIT_MACROS -DNEWLIB -D__USE_INLINE__ -I. -Iffmpeg -mcrt=newlib -mstrict-align -maltivec -I/SDK/Include/include_h/ -I/SDK/newlib/include/ -I/SDK/Local/newlib/include/ -I/SDK/Local/common/include/ -Ilibdvdread4/ -Ilibdvdnav/   -I/SDK/local/common/include/freetype2  
CC_DEPFLAGS = -MD -MP -O4    -ffast-math -fomit-frame-pointer


SRCS_LIBMPEG2-INTERNAL-yes = libmpeg2/idct_altivec.c libmpeg2/motion_comp_altivec.c 
...
EXTRALIBS          = -Wl,-z,noexecstack -mcrt=newlib -ffast-math  -faac -lvorbis -lpng -lz -lmng -ljpeg -lgif -llcms -L/SDK/local/newlib/lib -lfreetype -lz -lbz2 -lass -lz -lbz2 -llzo2 -lmad  -logg -lspeex -lmpg123 -lfaad -lopencore-amrnb -lopencore-amrwb -lxvidcore -lvpx -lopenjpeg -lnut -lpthread   -static -lm -mcrt
EXTRALIBS_MPLAYER  =  -static -lc -lm -lfaac -lSDL -lmp3lame -ltheora -lvorbisenc
