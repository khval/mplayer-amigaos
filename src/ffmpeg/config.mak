...
CC_IDENT=gcc 4.4.5 (Debian 4.4.5-8)
ARCH=ppc
CC=gcc
CXX=g++
AS=gcc
...
CFLAGS= -mstrict-align   -std=c99 -fomit-frame-pointer -maltivec -mabi=altivec -pthread -g -Wdeclaration-after-statement -Wall \
	-Wdisabled-optimization -Wpointer-arith -Wredundant-decls -Wwrite-strings  -Wundef -Wmissing-prototypes \
	-Wno-pointer-to-int-cast -Wstrict-prototypes -Wno-parentheses -Wno-switch -Wno-format-zero-length \
	-Wno-pointer-sign -O4 -fno-math-errno  -fno-tree-vectorize -Werror=implicit-function-declaration -Werror=missing-prototypes -Werror=return-type \
	 -L./ -L../ -L../../ -I./ -I../ -I../../ -I/SDK/Include/include_h/ -I/SDK/newlib/include/ -I/SDK/Local/newlib/include/ -I/SDK/Local/common/include/
...
WINDRES=windres
DEPWINDRES=gcc
LDFLAGS= -L./libpostproc -L./libswresample -L./libswscale -L./libavfilter -L./libavdevice -L./libavformat -L./libavcodec -L./libavutil -L./libavresample		\
		 -Wl,--as-needed -Wl,--warn-common -Wl,-rpath-link=libpostproc:libswresample:libswscale:libavfilter:libavdevice:libavformat:libavcodec:libavutil:libavresample
