...
EXTRALIBS          = -Wl,-z,noexecstack -mcrt=newlib -ffast-math  -faac -lvorbis -lpng -lz -lmng -ljpeg -lgif -llcms -L/SDK/local/newlib/lib -lfreetype -lz -lbz2  -lz -lbz2 -llzo2 -lmad  -logg -lspeex -lfaad -lopencore-amrnb -lopencore-amrwb -lxvidcore -lvpx -lopenjpeg -lnut -lpthread   -static -lm -mcrt
